...
def main(vacancy_name):
    ...
    scripts = [
        ('scripts/01_fetch_data/fetch_vacancies.py', 'Извлечение вакансий'),
        ('scripts/02_convert_to_csv/json_to_csv.py', 'Конвертация в CSV'),
        ('scripts/03_sort_data/sorter.py', 'Сортировка данных'),
        ('scripts/04_change_data/cleaner.py', 'Обогащение данных'),
        ('scripts/05_aggregate_data/counter.py', 'Агрегация данных'),
        ('scripts/06_partition_data/partitioner.py', 'Партиционирование'),
        ('scripts/06_partition_data/concatenator.py', 'Конкатенация')
    ]
